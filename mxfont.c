...
int SDL_PrintText(SDL_Surface *surf, struct SDL_Font *fnt, int x, int y,
                  Uint32 color, const char *src) {
...
void SDL_PrintTextScaled(SDL_Surface *surf, struct SDL_Font *fnt, int x, int y,
                         int w, int h, Uint32 color, const char *src) {
  SDL_Color text_color;
  SDL_Surface *text;
  SDL_Rect dst;
